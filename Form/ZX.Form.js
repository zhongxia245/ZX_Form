(function($) {
    ...
    */
    $.fn.Form = (function() {
        ...
        */
        var init = function(formConfig, formItems) {
            ...
            var defaultConfig = $.fn.Form.defaultConfig;
            ...
            for (var i = 0; i < formItems.length;) {
                ...
                while (colcount < defaultConfig.defaultCols) {
                    ...
                    var fn = "$.fn.Form.createCtl.ctl_" + itemConfig.controlId + "(itemConfig)";
                    var ctl = eval(fn);
    ...
    /*默认参数*/
    $.fn.Form.defaultConfig = {
        //必填项的样式
        defaulMustHtml: '<span style="color:red"> (*) </span>',
        //表单里面表格布局的表格
        defaulttable: '<table id="tblForm" border=1 rules="all" class="css_Form"></table>',
        //表格默认列数
        defaultCols: 4,
        //默认表单参数
        defaultFormConfig: {
